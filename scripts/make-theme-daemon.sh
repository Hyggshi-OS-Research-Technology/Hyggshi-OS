...
#
# Cách dùng:
#   ./scripts/make-theme-daemon.sh            # chỉ sinh source code
#   ./scripts/make-theme-daemon.sh --build    # sinh xong rồi cmake build luôn
#   ./scripts/make-theme-daemon.sh --install  # sinh + build + cài vào hệ thống
#
...
APP_DIR="$REPO_ROOT/app-for-hyggshi/hyggshi-theme-daemon"
